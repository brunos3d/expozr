...
* update server watch script to ensure server starts after build completion ([839e3c5](https://github.com/brunos3d/expozr/commit/839e3c56331848a804be517e7644ddc4d9ac0b10))
...
* **examples:** create webpack + typescript + express (host & remote apps) ([97253e3](https://github.com/brunos3d/expozr/commit/97253e3e921a282e0cd11a99216ae4766e56acb9))
...
* **navigator:** refactor module loading to support environment-aware loaders and enhance runtime detection ([c2bc1ed](https://github.com/brunos3d/expozr/commit/c2bc1edbc887606a2432af6e157462d5795580f4))
...
* refactor express host server to modular route structure and enhance development scripts ([ef5dfa9](https://github.com/brunos3d/expozr/commit/ef5dfa91c4f5568fbdb940ca5802f22caf263a66))
